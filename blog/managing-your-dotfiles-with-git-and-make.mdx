...
![Screenshot of a Makefile used to manage dotfiles](/dotfiles-makefile.png)
...
[^1]: Makefile syntax is finicky. Check out [makefiletutorial.com](https://makefiletutorial.com/).
